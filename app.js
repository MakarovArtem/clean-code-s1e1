...
var addButton = document.getElementById("add-button");//adding button
...
var createNewTaskElement = function(taskString){
  ...
  editButton.className = "button_text";
...
//select ListItems children
  ...
  var editButton = taskListItem.querySelector(".button_text");
...
//cycle over incompleted-taskHolder ul list items
//for each list item
